...
[_QWERTY] = {
  ...
  {KC_LCTL, KC_LGUI, TG(LOWER), KC_LALT, LOWER,  KC_LSFT, KC_SPC,  RAISE,   KC_DEL,  TG(RAISE), KC_NO,   KC_NO  }
},
 ...
 */
[_LOWER] = {
  {KC_TILD, KC_EXLM, KC_AT,   KC_UNDS, KC_LPRN, KC_RPRN, KC_PLUS, KC_7,    KC_8,    KC_9,    KC_EQL,  _______},
  {KC_HASH, KC_DLR,  KC_PERC, KC_PIPE, KC_LCBR, KC_RCBR, KC_MINS, KC_4,    KC_5,    KC_6,    KC_ASTR, KC_DOT },
  {KC_CIRC, KC_AMPR, KC_GRV,  KC_BSLS, KC_LBRC, KC_RBRC, KC_0,    KC_1,    KC_2,    KC_3,    _______, _______},
